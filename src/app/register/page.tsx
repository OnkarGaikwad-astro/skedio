...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F8F9FA] px-4 relative overflow-hidden py-12">
      {/* Decorative background elements */}
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-100 rounded-full blur-[120px] opacity-60" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-emerald-100 rounded-full blur-[120px] opacity-60" />
      ...
      <div className="w-full max-w-[440px] z-10">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-slate-900 mb-2">Register your School</h1>
          <p className="text-slate-500 text-sm">Create a secure space for your scheduling</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-11 rounded-[14px] bg-slate-50/50 border-slate-200"
              />
              <p className="text-xs text-slate-500">This will be used as your login ID.</p>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-primary text-primary-foreground rounded-[14px] font-medium text-sm hover:bg-primary/90 transition-all flex items-center justify-center gap-2 group shadow-sm mt-2 disabled:opacity-50"
            >
